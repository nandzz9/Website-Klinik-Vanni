                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-12">
                                <ul class="top-info text-center text-md-left mt-2">
                                    <li>
                                        <p class="text-white"><i class="fas fa-headset"></i> Customer Care | <strong>(0778) 123 456</strong> </p>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-4 col-md-4 top-social text-center text-md-right">
                                <ul class="mt-2">
                                    <li>
                                        <p class="text-white"><i class="fas fa-phone"></i> Emergency | <strong>(0778) 123 456</strong> </p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-between">
                        <div class="col-lg-4 col-md-6 footer-widget footer-about">
                            ...
                            <p class="text-white">Klinik Vanni adalah salah satu klinik di Brebes yang berdiri pada tanggal 5 Maret 2015.</p>
                            ...
                            <div class="footer-social">
                                <ul>
                                    <li><a href="https://www.facebook.com/profile.php?id=100080470151636" aria-label="Facebook"><i class="fab fa-facebook-f text-white"></i></a></li>
                                    <li><a href="https://www.youtube.com/@herahaerani" aria-label="Youtube"><i class="fab fa-youtube text-white"></i></a>
                                    </li>
                                    <li><a href="https://www.instagram.com/klinikvanni?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" aria-label="Instagram"><i class="fab fa-instagram text-white"></i></a></li>
                                </ul>
                            </div><!-- Footer social end -->
                        </div><!-- Col end -->

                        <div class="col-lg-4 col-md-6 footer-widget mt-5 mt-md-0">
                            <h3 class="widget-title">Jam Operasional Klinik</h3>
                            <div class="working-hours text-white">
                                Klinik Vanni melayani pasien IGD selama 24 jam dan pasien yang membutuhkan konsultasi bisa melihat jadwal dokter pada menu jadwal dokter <br>
                                jam kunjungan pasien:
                                <br><br> Senin - Minggu: <span class="text-right">08:00 - 16:00 </span>
                        ...
                        <div class="col-md-6">
                            <div class="copyright-info text-white text-center">
                                <span>Copyright &copy; <script>
                                    ...
                                    </script>, Klinik Vanni Brebes</span>
                            </div>
                        </div>
                    </div><!-- Row end -->
